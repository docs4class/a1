...
```
# Let's make some meaningful (but pretty!) pictures!
...
4. Create a faceted histogram where each facet represents a neighborhood and displays the distribution of Airbnb prices in that neighborhood. You4 histogram may be similar (or better! than the example below.)
